...
GROUP_DEFINITIONS = OrderedDict(
    (
        ...
        ("ml_cooling_correction", GroupDefinition("ml_cooling_correction", "[ML Cooling Correction]", "ML Cooling Correction")),
...
_SECTION_TO_GROUP = {
    ...
    "ML-Based Cooling Correction (LightGBM Regressor)": "ml_cooling_correction",
    "Cooling Correction Mode": "ml_cooling_correction",
