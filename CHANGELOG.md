...
- **Post-merge review cleanup**: Restored the missing `Files changed` block in the PV contract context entry and reformatted `new_addon_lines` in `.github/workflows/build.yaml` for readability.
